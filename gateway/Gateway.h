...
private:
	...
	Json::Value msgReqStatusCheck;
	Json::Value msgReqButtonCheck;
	Json::Value msgResetResult;
...
public:
	...
	Json::Value ButttonTest(Json::Value &dataRspLocal, int buttonId);
	string CheckDataRspLocal(Json::Value &dataRsp);
